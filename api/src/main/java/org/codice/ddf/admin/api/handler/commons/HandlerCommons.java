...
public class HandlerCommons {
    ...
    // TODO: tbatie - 2/8/17 - Lets replace this SUCCESSFUL_PERSIST constant with something more specific
    ...
    public static final String FAILED_DELETE = "SUCCESSFUL_DELETE";
