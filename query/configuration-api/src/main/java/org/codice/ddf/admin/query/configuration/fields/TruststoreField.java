...
import org.codice.ddf.admin.query.configuration.services.impl.TruststoreConfigurationImpl;
...
public class TruststoreField extends BaseObjectField {
  ...
  public static final String DESCRIPTION = "A list of of remote connections that should be trusted or not";
