...
import org.codice.ddf.admin.query.configuration.fields.TruststoreField;
...
public class SetTruststore extends BaseFunctionField<BooleanField>{
  ...
  public BooleanField performFunction() {
    return BooleanField.of(configurationManager.setTruststoreConfiguration(truststoreArg.toConfig()));
  }
