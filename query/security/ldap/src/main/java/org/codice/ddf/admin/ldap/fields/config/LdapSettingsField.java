...
public class LdapSettingsField extends BaseObjectField {
    ...
    private FilePathField attributeMappingPath;
    ...
    public LdapSettingsField() {
        ...
        this.attributeMappingPath = new FilePathField("attributeMappingPath");
    ...
    public List<Field> getFields() {
        return ImmutableList.of(usernameAttribute, baseUserDn, baseGroupDn,
                ...
                attributeMappingPath, attributeMap,
                useCase);
    }
    ...
    public String attributeMappingPath(){
        return attributeMappingPath.getValue();
    }
    ...
    public LdapSettingsField attributeMappingPath(String attributeMappingPath) {
        this.attributeMappingPath.setValue(attributeMappingPath);
        return this;
    }
